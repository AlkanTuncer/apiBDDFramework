...
public class CustomerPost {
     ...
     * @param email
     */
    public CustomerPost(int id, String lastName, String firstName, String email, String company, String phone, String address1, Object address2, String city, String state, String postalCode, String country) {
        super();
        this.id = id;
